...
import { Container, Row, Col , Button, ButtonGroup, Form, FormGroup, Label, Input, FormText, ListGroup, ListGroupItem } from 'reactstrap';
...
const OrgMembers = ({
    ...
    <div className="OrgMembers">
        ...
        <ListGroup>{memberships.map(member => (
